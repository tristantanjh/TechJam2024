...
const placeholderMessages = [
  ...
  // { type: "ai", text: "To set up an ad campaign in Tik Tok Ads Manager, follow these steps: Log into your Tik Tok Ads Manager account, click on 'Create ad', choose your advertising ibjective, set a campaign name, and establish a campaign budget. You can also decide on special ad categories, enable split testing, and optimize the campaign budget if necessary."},
  // { type: "human", text: "Who made the biggest purchase in Singapore Outlet 1?"},
  // { type: "ai", text: "The provided text does not contain information about individual purchases or details about who made the biggest purchase in Singapore Outlet 1."},
  // { type: "human", text: "Who made the biggest purchase in Singapore Outlet 1?"},
  // { type: "ai", text: "The biggest purchase in Singapore Outlet 1 was made by Customer ID 7."},
  // { type: "human", text: "Summarize the sales for Singapore Outlet 1"},
  // { type: "ai", text: "The total sales for Singapore Outlet 1, which has the Shop ID SG1, amounted to $599.23."},
  // { type: "human", text: "Summarize the sales for Singapore Outlet 1"},
  // { type: "ai", text: "At Singapore Outlet 1, the product that achieved the highest sales is 'Eau de Toilette,' which has the product ID 'ES41.' Additionally, the customer who made the most purchases from this outlet is John Doe, who is identified by the customer ID 7. This information highlights both the most popular product and the top customer at this specific location."},
  // { type: "human", text: "Help me create a Jira Issue"},
  // { type: "ai", text: "The provided texts do not contain information on how to create a Jira issue. Please refer to Jira's official documentation or support for guidance on creating an issue in Jira."}
];
