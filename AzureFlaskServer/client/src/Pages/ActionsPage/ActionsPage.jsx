  ...
  const [data, setData] = useState([
    {
      ...
      description:
        "Answers any queries related to automobile sales from the year of 2012 onwards",
      action_type: "Query",
    ...
    },
    {
      ...
      description:
        "Answers any queries related to shopping trends from the latest studies",
      action_type: "Query",
    ...
    },
    {
      ...
      description:
        "Answers any queries related to supermarket sales from the year of 2012 onwards",
      action_type: "Query",
